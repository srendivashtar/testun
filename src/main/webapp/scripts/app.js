...
var testunApp = angular.module('testunApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'testunAppUtils', 'pascalprecht.translate', 'truncate']);
